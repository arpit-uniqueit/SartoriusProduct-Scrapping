...
# Base URL
base_url = 'https://shop.sartorius.com/us/p/octet-streptavidin-sa-biosensor/18-5020'
cookies = {
    'NEXT_LOCALE': 'en-us',
...
while pages_checked < max_pages:
    ...
    # ✅ Correct XPath
    elements = driver.find_elements(By.XPATH, '//p[@class="font-bold"]/a[contains(@href, "/en-us/products/")]')
